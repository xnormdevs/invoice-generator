      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Easy Invoice.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Easy Invoice, accessible from{" "}
            <a
              href="https://invoice-generator-ashy.vercel.app/"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://invoice-generator-ashy.vercel.app/
            </a>
          </p>
        </li>
        <li>
